...
static NSString * const redLabelString = @"Noah";
static NSString * const blueLabelString = @"www.baidu.com";
static NSString * const subLeftString = @"iOS wikifx 开发者";
static NSString * const subRightString = @"喜欢运动,weibo帐号图一";
